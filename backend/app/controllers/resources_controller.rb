class ResourcesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to resources_path, notice: "Resource was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def resource_params
      params.require(:resource).permit(:name, :category, :unit_price)
    end
end
